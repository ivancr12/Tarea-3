...
2. Descargar el dataset US_Accidents_March23.csv desde Kaggle y colocarlo en la carpeta del proyecto.

3. Abrir el notebook Tarea_3.ipynb en Google Colab o Jupyter Notebook.
...
1. Polars es significativamente más rápido que Pandas en carga de datos (21.99x).
2. La ejecución diferida (Lazy) mejora el rendimiento en 1.43x.
3. Random Forest fue el mejor modelo predictivo.
4. El beneficio de Polars aumenta con el tamaño del dataset.
